		<div class="sec">
                ...
                <div class="container">
                    ...
                    <div class="col-md-7">
                        ...
                        <div class="bxcontact">
                            ...
                            <ul>
                                <li>
                                <div class="bxp">Business Type:</div>
                                    <div class="bxp1">Exporter / Manufacturer / Wholesaler/Distributor / Supplier / Trading Company</div>
                                </li>
                                <li>
                                <div class="bxp">Year Established:</div>
                                    <div class="bxp1">
                                    1996
                                    </div>
                                </li>
                               ...
                               <i class="fa fa-phone"></i>
                                ...
                                <li>
                                   <i class="fa fa-map-marker"></i>
                                    New no 15 / Old no : 6/4, Ashtabujam road, Choolai, Chennai, Tamil Nadu, 600112, India
                                    </li>
                            </ul>
                            </div>
                        </div>
                ...
                <section class="secondary_page_wrapper">
				<div class="container">
                    <h2 class="text-center widget_title">Popular Products</h2>
			<div class="row">
    ...
    <div id="products">
        ...
        <div class="item  col-xs-6 col-lg-3">
            <div class="thumbnail cp1">
                <img class="group list-group-image" src="images/compresor.png" alt="" />
                <div class="caption ">
    ...
    <div class="modal-dialog modal-lg">
      <div class="modal-content">
        ...
        <div class="modal-body">
         ...
         <div class="col-md-6">
            <figure>
             <img src="images/capacitor.png" alt="..">
             </figure>
    ...
    <div class="input-group">
      ...
      <input type="text" class="form-control" id="exampleInputAmount" placeholder="Mobile Number">
            ...
            <!--End Modal content-->
                    ...
                    <div class="row">
                    <div class="col-md-12 text-center">
                        <a href="" class="btn btn-primary">View more product</a>
    ...
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          ...
          <p><i class="fa fa-star"></i>Tips on getting accurate quotes. Please include product name, order quantity, usage, special requests if any in your inquiry.</p>
            <form action="" method="" name="">
            <div class="row">
                <div class="col-md-12">
                <div class="form-group">
            <textarea rows="5" cols="5" class="form-control" placeholder="Describe Your Requirements In Detail"></textarea>
            </div>
                    </div>
                </div> 
                    <div class="row">
