...
?>
							...
							<div class="col-xs-12">
								<div class="layerslider" style="width:100%; height: 250px;">
									<div class="ls-slide" data-ls="transition2d: 10, 27, 63, 67, 69;">
										<img class="ls-bg" src="<?php echo base_url();?>front_assets/images/home_slide_7.jpg" alt="">
									</div>
                                    <div class="ls-slide" data-ls="transition2d: 10, 27, 63, 67, 69;">
										<img class="ls-bg" src="<?php echo base_url();?>front_assets/images/home_slide_8.jpg" alt="">
									</div>
									<div class="ls-slide" data-ls="transition2d: 10, 27, 63, 67, 69;">
                                        <img class="ls-bg" src="<?php echo base_url();?>front_assets/images/home_slide_9.jpg" alt="">
											</div>
			...
			<div class="page_wrapper">
					...
					<div class="row">
						...
						<main class="col-md-9 col-sm-8">
                            <div class="">
							<div class="tabs products section_offset animated initialized visible fadeInDown" data-animation="fadeInDown" data-animation-delay="150" style="animation-delay: 150ms;">
				...
				<div class="table_layout">
				    <div class="table_row">
				            <div class="table_cell">
								...
								<img src="<?php echo base_url();?>front_assets/images/deals_img_1.jpg" alt="">
									</a>
                                    </div>          
                                </div>
		                      </div>
								...
								<div class="image_wrap">
                                    <a href="<?php echo base_url('Products');?>">
								<img src="<?php echo base_url();?>front_assets/images/deals_img_2.jpg" alt="">
                                        </a>
								</div>												
								</div>
                            </div>
				...
				<div class="image_wrap">
                    <a href="<?php echo base_url('Products');?>">
				<img src="<?php echo base_url();?>front_assets/images/deals_img_3.jpg" alt="">
                        </a>
				</div>				
				</div>
				</div>
                                    ...
                                    <div class="table_row">
												<div class="table_cell">
													<div class="product_item">
														<div class="image_wrap">
                                                            <a href="<?php echo base_url('Products');?>">
															<img src="<?php echo base_url();?>front_assets/images/deals_img_4.jpg" alt="">
                                                            </a>								
														</div>												
													</div>
												</div>
												<div class="table_cell">
													<div class="product_item">
														<div class="image_wrap">
                                                            <a href="<?php echo base_url('Products');?>">
															<img src="<?php echo base_url();?>front_assets/images/deals_img_5.jpg" alt="">
                                                            </a>  										
                                                        </div>
													</div>
												</div>
												<div class="table_cell">
													<div class="product_item">
														<div class="image_wrap">
                                                            <a href="<?php echo base_url('Products');?>">
															<img src="<?php echo base_url();?>front_assets/images/deals_img_6.jpg" alt="">
                                                            </a>											
														</div>												
													</div>
												</div>
                                        <div class="table_cell">
													<div class="product_item">
														<div class="image_wrap">
                                                            <a href="<?php echo base_url('Products');?>">
															<img src="<?php echo base_url();?>front_assets/images/deals_img_4.jpg" alt="">		</a>								
														</div>												
													</div>
												</div>
											</div>
											...
											<div class="table_row">
												<div class="table_cell">
													<div class="product_item">
														<div class="image_wrap">
                                                            <a href="<?php echo base_url('Products');?>">
															<img src="<?php echo base_url();?>front_assets/images/deals_img_7.jpg" alt="">
															</a>											
														</div>
													</div>
												</div>
												<div class="table_cell">
													<div class="product_item">
														<div class="image_wrap">
                                                            <a href="<?php echo base_url('Products');?>">
															<img src="<?php echo base_url();?>front_assets/images/deals_img_8.jpg" alt="">
															</a>
														</div>
													</div>
												</div>
												<div class="table_cell">
													<div class="product_item">
														<div class="image_wrap">
                                                            <a href="<?php echo base_url('Products');?>">
															<img src="<?php echo base_url();?>front_assets/images/deals_img_9.jpg" alt="">
															</a>
														</div>
													</div>
												</div>
											...
											<div class="table_row">
												<div class="table_cell">
													<div class="product_item">
														<div class="image_wrap">
                                                            <a href="<?php echo base_url('Products');?>">
															<img src="<?php echo base_url();?>front_assets/images/deals_img_10.jpg" alt="">
															</a>		
														</div>
													</div>
												</div>
												<div class="table_cell">
													<div class="product_item">
														<div class="image_wrap">
                                                            <a href="<?php echo base_url('Products');?>">
															<img src="<?php echo base_url();?>front_assets/images/deals_img_11.jpg" alt="">
                                                                </a>
                                                        </div>
													</div>
												</div>
												<div class="table_cell">
													<div class="product_item">
														<div class="image_wrap">
                                                            <a href="<?php echo base_url('Products');?>">
															<img src="<?php echo base_url();?>front_assets/images/deals_img_12.jpg" alt="">
                                                                </a>
														</div>
													</div>
												</div>
											...
											<div class="table_row">
												<div class="table_cell">
													<div class="product_item">
														<div class="image_wrap">
                                                            <a href="<?php echo base_url('Products');?>">
															<img src="<?php echo base_url();?>front_assets/images/deals_img_13.jpg" alt="">
                                                                </a>		
														</div>
													</div>
												</div>
												<div class="table_cell">
													<div class="product_item">
														<div class="image_wrap">
                                                            <a href="<?php echo base_url('Products');?>">
															<img src="<?php echo base_url();?>front_assets/images/deals_img_14.jpg" alt="">
                                                                </a>			
														</div>
													</div>
												</div>
												<div class="table_cell">
													<div class="product_item">
														<div class="image_wrap">
                                                            <a href="<?php echo base_url('Products');?>">
															<img src="<?php echo base_url();?>front_assets/images/deals_img_15.jpg" alt="">
                                                                </a>
														</div>
													</div>
												</div>
      ...
      <ul class="row">
        <li><div class="col-md-4"><a href="#" target="_blank"> National Security</a></div>
            <div class="col-md-4"><img src="<?php echo base_url();?>front_assets/images/in.jpg" alt=".." class="flag"> India</div>
                      ...
                      <section class="section_offset animated visible fadeInDown" data-animation="fadeInDown">
								...
								<div class="table">
                                    ...
                                    <div class="form-group col-md-4">
                                        <input type="text" placeholder="Products / Services you are looking for" class="form-control">
                                        </div>
                                         <div class="form-group col-md-4">
                                        ...
                                        <div class="row pd4">
                                         <div class="form-group col-md-12">
                                             <textarea  placeholder="Describe Your Buying Requirements in detail" rows="3" cols="3" class="form-control"></textarea>
                                        </div>
                                            </div>
                                        <div class="row pd4">
                                        <div class="form-group col-md-4">
